...
function SubjectIcon(props) {
  return (
    ...
    >
      ...
      <path
        d="M16.5 12c0 2.7-.548 5.12-1.412 6.848C14.21 20.604 13.09 21.5 12 21.5c-1.09 0-2.21-.896-3.088-2.652C8.048 17.12 7.5 14.7 7.5 12c0-2.7.548-5.12 1.412-6.847C9.79 3.396 10.91 2.5 12 2.5c1.09 0 2.21.896 3.088 2.653C15.952 6.879 16.5 9.299 16.5 12z"
        stroke="#222"
      />
      <path
